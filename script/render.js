...
export async function renderModal(summoner, account, champions, mostPlayedChampions) {
    ...
    modalRank.appendChild(modalRankPoints)

    championsDiv.appendChild(modalChampions)
    championsDiv.classList.add("champions")

    modalDescription.append(championsDiv, modalWinrate)
    ...
    modalPerfilImg.append(modalImg, modalLevel)

    modalText.append(modalNick, modalRank)
    modalRankLogo.appendChild(modalRankImg)

    modalPerfil.append(modalPerfilImg, modalText, modalRankLogo)
